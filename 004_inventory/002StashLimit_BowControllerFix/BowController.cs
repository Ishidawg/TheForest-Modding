...
namespace TheForest.Items.World
{
	...
	public class BowController : MonoBehaviour, IBurnableItem
	{
		...
		// (get) Token: 0x060057C4 RID: 22468
		...
		// (get) Token: 0x060057C5 RID: 22469
		...
		// (get) Token: 0x060057C6 RID: 22470
		private InventoryItemView CurrentArrowItemView
		{
			get
			{
				List<InventoryItemView> arrowViews = LocalPlayer.Inventory.InventoryItemViewsCache[this._ammoItemId];
				int clampedIndex = Mathf.Clamp(LocalPlayer.Inventory.AmountOf(this._ammoItemId, false) - 1, 0, arrowViews.Count - 1);
				return arrowViews[clampedIndex];
			}
		}

		// Token: 0x170008E9 RID: 2281
		// (get) Token: 0x060057C7 RID: 22471
